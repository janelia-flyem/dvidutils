...
namespace dvidutils
{
    ...
    PYBIND11_MODULE(_dvidutils, m) // note: PYBIND11_MODULE requires pybind11 >= 2.2.0
    {
        ...
        m.def("downsample_labels", &py_downsample_labels<int64_t>, "labels"_a, "factor"_a, "suppress_zero"_a=false);
        m.def("downsample_labels", &py_downsample_labels<int32_t>, "labels"_a, "factor"_a, "suppress_zero"_a=false);
        m.def("downsample_labels", &py_downsample_labels<int16_t>, "labels"_a, "factor"_a, "suppress_zero"_a=false);
        m.def("downsample_labels", &py_downsample_labels<int8_t>,  "labels"_a, "factor"_a, "suppress_zero"_a=false);
